        ...
        [
            ...
            (
                ...
                (
                    ...
                    "- em `action_type`, classifique cada item como `auto_fix_candidate`, `author_confirmation` ou `production_request`;\n"
                    "- use `auto_fix_candidate` para erro local, objetivo e seguro;\n"
                    "- use `author_confirmation` quando a revisão tocar em sentido, formulação técnica, data, sigla, autoria, remissão ou decisão que dependa do autor;\n"
                    "- use `production_request` quando faltar elemento editorial, como fonte, crédito, título, numeração, nota, metadado ou referência completa;\n"
